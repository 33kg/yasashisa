					...
					<div id="categoiesBottom">
						...
						<section>
							...
							<ul>
								...
								<li><a href="<?php bloginfo('url'); ?>/archives/item_category/category07">∟ 京の心石鹸</a></li>
								<li><a href="<?php bloginfo('url'); ?>/archives/item_category/category08">∟ クリーム・オイル</a></li>
							</ul>
						</section>
						<section>
							<h3>バス用品・雑貨</h3>
							<ul>
								<li><a href="<?php bloginfo('url'); ?>/archives/item_category/category09">∟ バス用品・雑貨</a></li>
